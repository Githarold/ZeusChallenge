...
class move_zeus():
    ...
    def __init__(self):
        ...
        self.rb.settool(id = 4, offrz = self.offset_rz, offz = offset_4)
        ...
        self.m = MotionParam(jnt_speed=40, lin_speed=80, overlap=30, acctime=1, dacctime=1)
    ...
    def move_to_object(self, pose_array):
        ...
        # pose = curr_pos_list[7]
        position = Position( x, y, z, rz, ry, rx, posture = 6)
        self.rb.move(position)
    ...
    def move_pose_estimate_pos(self):
        ...
        # curr_pos = self.rb.getpos()
        # curr_pos_list = curr_pos.pos2list()
        place_position = Position( X= 227.90,Y = 485.03,Z = 331.51,rz = -89.97,ry = 0.02,rx = -179.97, posture = 6)
        print "packaging!!"
        self.rb.move(place_position)
        self.rb.sleep(0.5)
    ...
    def pick(self):
        ...
        pick_position2 = Position( curr_pos_list[0], curr_pos_list[1], 150.60, -90.0, 0.0, -180.0, posture = curr_pos_list[7])
        self.rb.move(pick_position2)
        pick_position2 = Position( x = 497.37,y = 242.28,z = 313.53,rz = -90.0 - self.offset_rz, ry = -0.00,rx = -180.0, posture = curr_pos_list[7])
        self.rb.move(pick_position2)
    ...
    def place(self, z_pos):
        ...
        self.rb.sleep(2)
        # curr_pos_list = curr_pos.pos2list()
        # pick_position2 = Position( curr_pos_list[0], curr_pos_list[1], curr_pos_list[2] - z_pos, curr_pos_list[3], curr_pos_list[4], curr_pos_list[5], posture = curr_pos_list[7])
        # self.rb.move(pick_position2)
